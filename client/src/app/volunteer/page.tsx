...
export default function VolunteerPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-center items-stretch gap-6 mx-auto max-w-5xl">
        <div className="w-full md:w-1/2 flex-1">
          {/* Volunteer Application */}
          <Card className="bg-white h-full shadow-[0_4px_20px_rgba(0,0,0,0.1)] border border-gray-100">
            <CardHeader>
