...
您的支持將直接影響30名四年級學生，並且這些套件可以在未來幾年繼續使用，惠及更多學生。謝謝您考慮支持我們的科學教育！`,
    teacherMessage: '作為一名科學老師，我相信動手實踐是學習的最佳方式。這些套件將改變我們的課堂體驗！',
    items: [
    ...
    updates: [
      { date: '2025-03-15', message: '我們已經籌集了60%的資金！非常感謝所有的支持者。' }
    ],
    donors: [
          ...
          <div className="project-main">
            <div className="project-header">
              ...
              <div className="project-meta">
                ...
                <p className="school-info">{project.schoolName}, {project.location}</p>
              </div>
            </div>
          ...
          <div className="project-sidebar">
            <div className="donation-progress">
              ...
              <div className="progress-info">
                <span className="donors-count">{project.donors.length} 位捐贈者</span>
